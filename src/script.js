...
const environmentMap = textureLoader.load('/environmentMap/space/hdr.png')
...
parameters.insideColor = '#00fffb'
parameters.outsideColor = '#e238e5'
...
const generateGalaxy = () =>
{
    ...
    material = new THREE.ShaderMaterial({
        ...
        vertexColors: true, // = attribute vec3 color
